...
if [ -f "$(gettop)/bootable/recovery/orangefox.cpp" ]; then
	...
	if [ "$1" = "$FDEVICE" ] || [  "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
		...
		export FOX_BUILD_TYPE="Unofficial"
    		export FOX_TARGET_DEVICES="fleur"
	  	export TARGET_DEVICE_ALT="fleur"
	  	export LC_ALL="C"
		...
		F=$(find "device" -maxdepth 2 -name "fleur")
		...
		echo -e "\x1b[96fleur: When you see this message, all OrangeFox Vars have been added!\x1b[m"
